...
export default function LoginScreen() {
 ...
 const { username: normalizedUsername, password: normalizedPassword } =
 getNormalizedCredentials();
 ...
 setUsername(normalizedCredentials.username);
 setPassword(normalizedCredentials.password);
 console.log('Submitting credentials:', {
 username: normalizedCredentials.username,
 password: normalizedCredentials.password ? '***' : 'EMPTY',
 });
 setLoading(true);
